...
const extensionId = "piyushdoorwar.getll";
...
if (extension?.extensionName !== "getll" || !Number.isFinite(installs) || installs < 0) {
  throw new Error("VS Marketplace returned an invalid NuGet LL install count");
}
